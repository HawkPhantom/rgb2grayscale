...
module AESL_axi_s_OUTPUT_STREAM (
    ...
    fifo #(3328, 24) fifo_OUTPUT_STREAM_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(3328, 3) fifo_OUTPUT_STREAM_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(3328, 3) fifo_OUTPUT_STREAM_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(3328, 1) fifo_OUTPUT_STREAM_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(3328, 1) fifo_OUTPUT_STREAM_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(3328, 1) fifo_OUTPUT_STREAM_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(3328, 1) fifo_OUTPUT_STREAM_TDEST (
        .reset(1'b0),
        .write_clock(clk),
