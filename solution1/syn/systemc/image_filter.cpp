...
void image_filter::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sync_ready.read()) && 
         esl_seteq<1,1,1>(Block_Mat_exit47_pro_U0_ap_ready.read(), ap_const_logic_0))) {
        Block_Mat_exit47_pro_U0_ap_ready_count = (!Block_Mat_exit47_pro_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(Block_Mat_exit47_pro_U0_ap_ready_count.read()) - sc_biguint<2>(ap_const_lv2_1));
                ...
                esl_seteq<1,1,1>(Block_Mat_exit47_pro_U0_ap_ready.read(), ap_const_logic_1))) {
        Block_Mat_exit47_pro_U0_ap_ready_count = (!Block_Mat_exit47_pro_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(Block_Mat_exit47_pro_U0_ap_ready_count.read()) + sc_biguint<2>(ap_const_lv2_1));
    }
...
void image_filter::thread_ap_sync_ready() {
    ap_sync_ready = (ap_sync_AXIvideo2Mat_U0_ap_ready.read() & ap_sync_Block_Mat_exit47_pro_U0_ap_ready.read());
}
